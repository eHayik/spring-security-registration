...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, managerPrivilege, passwordPrivilege));
        ...
        createUserIfNotFound("manager@test.com", "Test", "Manager", "manager1", new ArrayList<>(Arrays.asList(managerRole)));
